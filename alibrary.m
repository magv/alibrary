...
Module[{model, options, nomasspat, filter, tmpdir, tmpoutput, momi, momo, i, result},
  ...
  filter = Replace[OptionValue[QGrafFilter], None -> If[ValueQ[$QGrafFilter], $QGrafFilter, ""]];
...
Options[Diagrams] = {QGraf -> None, QGrafModel -> None, QGrafOptions -> None, MasslessFieldPattern -> None, QGrafFilter -> None};
