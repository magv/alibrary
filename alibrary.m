...
Module[{model, options, noMassPattern, extra, diagramFilter, momI, momO, i, result},
  ...
  diagramFilter = Replace[OptionValue[DiagramFilter], None -> If[ValueQ[$QGrafDiagramFilter], $QGrafDiagramFilter, ""]];
